...
import { ШАГ, type Walker, moveWalkers, placeWalkers, walkerPose, фазаШага } from './city/walkers.ts';
import { СЕКУНД_В_ЧАСЕ, type Зачем, type Расселение, где as гдеЖителя, кто, расселить } from './city/житель.ts';
import {
  ЧАС_УТРА, type Снаружи, вывестиНаУлицу, гдеЖитель, дворНаЧас, жить, одеждаЖителя, сколькоМашин, сколькоПешеходов,
} from './city/жизнь.ts';
